# v2-pretrain-ablation-review-001
...
- 代表角色：`['ib_output_changed']`
- 目标行为：`view`
- UTC日编号：`16668`
- 历史长度/行为：`6 / {'view': 6}`
- 目标SID列表：`[[232, 214, 78], [16, 57, 236]]`
...
- Full：`{'generated_sids': [[217, 119, 241], [254, 214, 146]], 'sid_token_hits': [False, False, False, False, False, False], 'sid_token_accuracy': 0.0, 'geometric_token_reward': 0.0, 'sid_recall': 0.0, 'all_generated_items_legal': True, 'generated_items_unique': True}`
