...
| EA-TOSD（熵感知的轨迹优化自蒸馏）                    | 真实公开数据代理CUDA贯通，案例验收中 | 几何reward、best-of-G、未来SID共享Teacher、双熵蒸馏、SFT anchor、同split真实future与checkpoint迁移 | 28.125%样本非零reward；已review四个零reward/高熵/稀有行为例，待成功例与token级前后指标，尚无收益结论 |
