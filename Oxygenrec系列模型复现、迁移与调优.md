...
| EA-TOSD（熵感知的轨迹优化自蒸馏）                    | 真实公开数据代理CUDA贯通，连续差异诊断中 | 几何reward、best-of-G、未来SID共享Teacher、双熵蒸馏、SFT anchor、同split真实future与checkpoint迁移 | 28.125%样本非零reward；五个正反案例已review；SFT-only与EA单步离散指标相同，待参数/logit差异，尚无收益结论 |
