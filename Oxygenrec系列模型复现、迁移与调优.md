...
| EA-TOSD（熵感知的轨迹优化自蒸馏）                    | 真实公开数据代理CUDA贯通，输出变化案例review中 | 几何reward、best-of-G、未来SID共享Teacher、双熵蒸馏、SFT anchor、同split真实future与checkpoint迁移 | EA相对SFT改变80/96个参数张量及2/32条greedy列表，但未新增目标token命中，尚无收益结论 |
